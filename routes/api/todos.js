...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      let createdTag = {};
      if (tag._id.toString() === "655b5abe61963e5f9766c256") {
      ...
      const newTodo = new Todo({
        name: user.name,
        tags:
          tag._id.toString() === "655b5abe61963e5f9766c256"
            ? [createdTag]
            : [tag],
        text: req.body.text,
        user: req.user.id,
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      let createdTag = {};
      if (tag._id.toString() === "655b5abe61963e5f9766c25") {
        const newTag = new Tag({
          name: req.body.tag,
        });
        createdTag = await newTag.save();
      ...
      if (todo) {
        ...
        todo.tags =
          tag._id.toString() === "655b5abe61963e5f9766c25"
            ? [createdTag]
            : [tag];
      }
